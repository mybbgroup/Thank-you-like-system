...
$l['tyl_thankslike_desc'] = "Choose if you want to use the Thank You or the Like System.";
...
$l['tyl_hideforgroups_desc'] = "Select User Groups which cannot see Thank/Like button.";
