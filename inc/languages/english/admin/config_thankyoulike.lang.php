...
$l['tyl_info_desc_warning'] = "<strong>Warning! tyl_unlock file located! Uninstalling will remove ALL the thankyou/like data from the database. If you would like to preserve the thankyou/like data while uninstalling then remove the tyl_unlock file from the forum root folder.</strong>";
...
$l['tyl_firstalloverwrite_title'] = "Special option for Display ThankYou/Like buttons in ALL Posts";
...
$l['tyl_unameformat_desc'] = "Do you want to format the usernames in the Thanks/Like list according to their groups?";
