...
$l['tyl_display_tyl_counter_forumdisplay_title'] = "Enable thanks/likes counter for the first post in forumdisplay_thread template?";
$l['tyl_display_tyl_counter_forumdisplay_desc'] = "Selecting \"Yes\" will display the counter in forumdisplay_thread template of thanks/likes received in the first post of the thread.";

$l['tyl_display_tyl_counter_search_page_title'] = "Enable thanks/likes counter for the first post in search_results_threads_thread template?";
$l['tyl_display_tyl_counter_search_page_desc'] = "Selecting \"Yes\" will display the counter in search_results_threads_thread template of thanks/likes received in the first post of the thread.";
