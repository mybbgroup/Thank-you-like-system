...
$l['tyl_thankyou_sm'] = "thank you";
$l['tyl_thanked'] = "Thanked";
$l['tyl_thanked_sm'] = "thanked";
$l['tyl_thanks'] = "Thanks";
$l['tyl_thanks_sm'] = "thanks";
$l['tyl_thanksyoufor_sm'] = "thanks you for";
$l['tyl_thankyoufor_sm'] = "thank you for";
$l['tyl_like'] = "Like";
$l['tyl_like_sm'] = "like";
$l['tyl_liked'] = "Liked";
...
$l['tyl_tyls_rcvd'] = "{1} Received";
$l['tyl_tyls_given'] = "{1} Given";
$l['tyl_tyls_rcvd_bit'] = "{1} in {2} posts";
...
$l['tyl_total_tyls_given'] = "Total {1} Given:";
$l['tyl_total_tyls_rcvd'] = "Total {1} Received:";
$l['tyl_tylpd_percent_total'] = "{1} per day | {2} percent of total {3}";
$l['tyl_find_tyled_threads'] = "Find All {1} Threads";
$l['tyl_find_tyled_posts'] = "Find All {1} Posts";
$l['tyl_find_tyled_threads_for'] = "Find All Threads {1} For";
$l['tyl_find_tyled_posts_for'] = "Find All Posts {1} For";
...
$l['tyl_alert_one_tyl'           ] = '{1} {2} your post<br /><b>"{3}"</b>.';
$l['tyl_alert_two_tyls'          ] = '{1} and 1 other ({2} new) {3} your post<br /><b>"{4}"</b>.';
$l['tyl_alert_three_or_more_tyls'] = '{1} and {2} others ({3} new) {4} your post<br /><b>"{5}"</b>.';
$l['myalerts_setting_tyl'        ] = 'Receive an alert when someone adds a {1} to your post?';
...
$l['tyl_firstpost_tyl_count_search_page'] = "Total {1} received in the first post";
